...
# Group 03: Restaurant Delivery System
    ...
    while ans == 'y' or ans == 'Y':
        ...
        with open('menu.txt', 'r') as menu_file:
            for line in menu_file:
                ...
                print(f"\033[1mItem Price       \033[0m: RM{float(item_price):.2f}")
        ...
        print("\033[1mItem Price   \033[0m: RM"+str(menu[item_id]["item_price"]))
        print("\033[1mQuantity     \033[0m: "+str(quantity))
        print("\033[1mDelivery Fee \033[0m: RM5.0")        
        print("\033[1mTotal        \033[0m: RM"+str(total)+"\n")
...
def user_search_order(username):
    ...
    # Ask uswe to enter status number
...
def user_cancel_order(username):
    ...
    if ans == '1':
        ...
        with open('order.txt', 'r') as order_file:
            ...
            # Update the status in order_lines list
            order_index = order_number_mapping[order_number]
            order_lines[order_index] = order_lines[order_index].replace("Order placed", "Cancelled")

            # Write the updated order status into order.txt
        ...
        with open('login.txt', 'r') as login_file:
            ...
            for line in login_file:
                ...
                if login_username == username:
                    ...
                    ans = input("Press [Y] if you want to do another search, or any key to return to the main menu: ")
                    clear_screen()
    ...
    while ans == 'y' or ans == 'Y':
        ...
        with open("menu.txt", "r") as file:
            for line in file:
                ...
                print("----------------------------")
                print("\033[1mItem Name       \033[0m : " + item_name)
                print("\033[1mItem Price      \033[0m : RM" + str(item_price))
...
def display_item():
    ...
    with open("menu.txt", "r") as file:
        for line in file:
            ...
            print("-----------------")
            print("\033[1mItem Name       \033[0m : "+item_name)
            print("\033[1mItem Price      \033[0m : RM"+item_price)
            print("\033[1mItem Description\033[0m : "+item_desc + "\n")
...
def admin_function():
    ...
    while choice != 13:
        ...
        print("[10] Display All Restaurant Branch Info and Open Hours")
        print("[11] Adjust Restaurant Open Hours\n")
        print("[12] Logout")
        print("[13] Exit\n")
